        ...
        <section className="hero hero-cinematic">
          ...
          <div className="hero-inner hero-cinematic-inner">
            <div className="hero-copy">
              <span className="hero-eyebrow">LYFELYTIC · EVERYDAY TECH & ACCESSORIES</span>
              <h1 className="hero-title">Innovation for<br /><span className="hero-accent">everyday life.</span></h1>
              <p className="hero-sub">Discover smart, useful products designed to make your everyday moments simpler, better and more connected.</p>
              <div className="hero-actions">
                <button className="hero-primary-btn" onClick={() => window.scrollTo({ top: 650, behavior: 'smooth' })}>Explore Collection <ChevronRight size={17} /></button>
                <span className="hero-trust"><span className="hero-trust-dot"></span> Cash on Delivery across Pakistan</span>
              </div>
            </div>

            <div className="hero-visual" aria-label="Featured product">
              <div className="hero-visual-ring"></div>
              <div className="hero-visual-glow"></div>
              {products.length > 0 ? (
                <button className="hero-product" onClick={() => setSelectedProduct(products[0])} aria-label={`View ${products[0].name}`}>
                  <img src={getThumb(products[0])} alt={products[0].name} />
                </button>
              ) : (
                <div className="hero-product hero-product-placeholder"><Package size={68} /></div>
              )}
              <div className="hero-floating-card hero-floating-card-top"><span>01</span><strong>Smart picks</strong><small>Built for daily life</small></div>
              <div className="hero-floating-card hero-floating-card-bottom"><span className="hero-live-dot"></span><strong>Fast delivery</strong><small>Real WhatsApp support</small></div>
            </div>
          </div>
